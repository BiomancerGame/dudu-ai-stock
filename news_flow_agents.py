...
"""
    ...
    def investment_advisor_agent(self, sector_analysis: Dict,
        ...
        prompt = render_prompt(
            "news_flow_investment_advisor",
            flow_total_score=flow_data.get("total_score", "N/A"),
